...
public class ProductController {
    ...
    @Operation(summary = "Delete a product by productId", description = "Delete a product by productId")
    public ProductDto deleteProductById(@PathVariable(name = "productId") String productId) {
        validateArgument(productId == null || productId.isEmpty(), "Product Id cannot be null or empty");
        return productService.findProductById(productId);
    }
    ...
    @GetMapping("/products")
    @Operation(summary = "Find all product", description = "Find all products")
